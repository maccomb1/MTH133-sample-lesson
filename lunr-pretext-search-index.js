...
},
{
  ...
  "number": "1.1",
  "title": "",
  "body": "  Have a semi-relaxing day after your recent exam. Today’s focus is on exploring ideas.  Get introduced to the idea of an \"infinite polynomial\" and see how it can be used in place of a more complicated function.  Work through how to build part of an infinite polynomial for .  See how these polynomials can approximate real function values and even estimate tricky integrals.  Leave class with a sense of where we're headed for this upcoming Chapter.   "
},
{
...
},
{
  ...
  "number": "1.1.3",
  "title": "Power Series.",
  "body": " Power Series   A power series is an infinite polynomial of the form where the coefficients are constants and is the variable.   "
},
{
  "id": "sec-intro-9",
  "level": "2",
...
},
{
  ...
  "number": "1.1.5",
  "title": "",
  "body": "  Consider the function    Construct the 6th-degree Maclaurin polynomial for .    Approximate with . Compare to a calculator value and report the absolute difference.    Comment briefly on whether you expect the approximation to be better or worse at than at (from part(b))and why.     "
},
{
  "id": "ex-eu",
  "level": "2",
